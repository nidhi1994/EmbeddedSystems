...
1/(8Mhz/8)*256=0.256ms     0.2ms        0.06ms          0.26m
...
//Timer 0 Set-Up
 ...
 OCR0=0xBF;     //We want duty cycle of 75% in non-inverting mode so by using formula (OCR0+1)/256*100=75 we get value of OCR0 as 191 and its hex value as BF.
