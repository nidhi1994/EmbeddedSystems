...
Expected Time Period      ON time         OFF time        Actual Time Period
 1/(8Mhz/64)*256*2=4.4ms  3.2ms           1.2ms           4.4ms
...
//Timer 0 Set-Up
 ...
 OCR0=0x40;           //We want duty cycle of 75% in inverting mode so by using formula (256-OCR)/256*100=75 we get value of OCR0 as 64 and its hex value as 40.
