...
Expected Time Period       ON time         OFF time        Actual Time Period
 1/(8Mhz/64)*256*2=4.4ms  2.7ms           1.7ms           4.4ms
...
//Timer 0 Set-Up
 ...
 OCR0=0x66;           //We want duty cycle of 60% in inverting mode so by using formula (256-OCR)/256*100=60 we get value of OCR0 as 102.4 and its hex value as 66.
