...
Expected Time Period      ON time         OFF time        Actual Time Period
 1/(8Mhz/64)*256*2=4.4ms  0.8ms           3.2ms           4.4ms
...
//Timer 0 Set-Up
 ...
 OCR0=0xCD;           //We want duty cycle of 20% in inverting mode so by using formula (256-OCR)/256*100=20 we get value of OCR0 as 204.8 and its hex value as CD.
