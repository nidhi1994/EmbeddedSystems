...
1/(8Mhz/8)*256=0.256ms    0.21ms        0.05ms          0.26ms
...
//Timer 0 Set-Up
 ...
 OCR0=0xCC;     //We want duty cycle of 80% in non-inverting mode so by using formula (OCR0+1)/256*100=80 we get value of OCR0 as 203.8 and its hex value as CC.
