...
1/(8Mhz/64)*256=2.2ms  1.7ms           0.5ms           2.2ms
*/
void main() {
// PORTB Set-Up
...
//Timer 0 Set-Up
 ...
 OCR0=0x33;     //We want duty cycle of 80% in inverting mode so by using formula (256-OCR0)/256*100=80 we get value of OCR0 as 51.2 and its hex value as 33.
