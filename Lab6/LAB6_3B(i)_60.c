...
Expected Time Period            ON time         OFF time        Actual Time Period
 1/(8Mhz/8)*256*2= 0.512        0.32ms          0.2ms          0.52ms
...
//Timer 0 Set-Up
 ...
 OCR0=0x99;     //We want duty cycle of 60% in non-inverting mode so by using formula (OCR+1)/256*100=60 we get value of OCR0 as 152.6 and its hex value as 99.
