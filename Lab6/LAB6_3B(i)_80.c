...
1/(8Mhz/8)*256*2= 0.512        0.42ms          0.10ms          0.52ms
...
//Timer 0 Set-Up
 ...
 OCR0=0xCC;     //We want duty cycle of 80% in non-inverting mode so by using formula (OCR+1)/256*100=80 we get value of OCR0 as 203.8 and its hex value as CC.
