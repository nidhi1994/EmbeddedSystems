     // Write and test program that continuously reads voltage (0-5V) at Pin A.0 and displays the voltage with 3 decimal points at LCD.
...
while(1)
{
 if(flag==1)
 {
  ADMUX=0b00000000;      //Reference Voltage Vcc, Left Adjust, ADC1
 Cursor_Position(1,1);
 LCD_Print("CH0");
  Cursor_Position(1,5);
  temp=num/1000;
