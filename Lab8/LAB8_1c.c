...
void main() {
 ...
 Cursor_Position(1,16);   //Adjust cursor position at 1 row and 16 column as we have to rotate text from left to right.

 LCD_Print(disp1); //Diplay Text

 while(1)
  {
  lcdCommand(0x18);  //to rotate text
